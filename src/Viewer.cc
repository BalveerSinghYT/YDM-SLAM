...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("YDM-SLAM: Map Viewer",1024,768);
    ...
    Ow.SetIdentity();
    cv::namedWindow("YDM-SLAM: Current Frame");
    ...
    while(1)
    {
        ...
        // std:: cout <<"mImageViewerScale = "<<mImageViewerScale<<std::endl;
        ...
        // // resize mask to the same size as toShow if mask is not empty
